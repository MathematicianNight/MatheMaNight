...
const openGoogleMap = () => {
  setTimeout(() => {
    window.location.href =
      "https://www.google.com/maps/search/?api=1&query=더블유파티";
  }, 900);
};
const openNaverMap = () => {
  setTimeout(() => {
    ...
    window.location.href =
      "https://m.map.naver.com/search2/site.naver?query=더블유파티&sm=hty&style=v5&code=35643864";
  }, 800);
};
const openKakaoMap = () => {
  setTimeout(() => {
...
const LaunchMapApp = () => {
  ...
  return (
    <MapContainer isBlurred={isBlurred} onClick={showIcons}>
      <img className="map-app-background" src={Images.location_drawing} />
      ...
      <div className="copy-addr">
        ...
        <span
          className="copy-addr-button"
          onClick={() =>
            copyClipBoard("서울 성북구 동소문로 284 길음 서희스타힐스")
          }
        >
